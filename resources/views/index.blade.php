    ...
    <section class="relative h-screen bg-cover bg-center text-white flex items-center justify-center"
        ...
        <div class="relative z-10 text-center px-4 max-w-4xl">
            ...
            <p class="mt-4 text-lg md:text-xl font-light text-gray-100">
                Where serenity meets celebration — explore lush landscapes, hidden blooms, and peaceful corners designed
                for
            ...
            <div class="flex flex-col md:flex-row gap-12 items-start">
                ...
                <div class="md:w-1/2">
                    ...
                    <p class="text-xl md:text-2xl text-gray-700 leading-relaxed mb-6">
                        Step into Señorito’s Garden, a sanctuary where time slows and nature speaks. From floral trails
                        to
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Celebrate weddings, birthdays, or corporate gatherings in the
                                    heart
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Enjoy moments of mindfulness with garden yoga, meditation
                                    zones,
                    ...
                    <ul class="space-y-6">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-600">
                                    Whether you're planning a wedding, corporate event, or a birthday, we offer the
                                    perfect
    ...
    <section class="py-16 bg-gray-100">
            ...
            <div class="flex flex-col gap-12">
                ...
                <div>
                    ...
                    <p class="text-xl md:text-2xl text-gray-700 leading-relaxed mb-8 text-center">
                        Have questions or want to book an event? We're here to assist you and make your experience
                        memorable.
                    </p>
                    ...
                    <div class="text-center mb-12">
                        <p class="text-lg text-gray-600 mb-4 mx-auto max-w-3xl">
                            Whether you're planning a special event, have questions about our garden, or want to
                            schedule a tour, we're just a click away. Let us help you create unforgettable moments at
                            Señorito's Garden.
                        </p>
                        <p class="text-lg text-gray-600 mb-6 mx-auto max-w-3xl">
                            Reach out to us, and our team will be happy to answer any inquiries or assist with booking
       ...
       cursor-pointer">
                ...
                <div class="mt-12 text-center">
                    ...
                    <p class="text-lg text-gray-600 mb-4 mx-auto max-w-3xl">
                        Our garden offers a unique blend of natural beauty, modern amenities, and an elegant setting,
                        making it the perfect venue for any occasion. Whether it's a wedding, corporate event, or
                        personal celebration, Señorito's Garden provides the ideal backdrop for your special day.
                    </p>
