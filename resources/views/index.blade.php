...
<head>
    ...
    <link rel="preload"
          href="https://fonts.googleapis.com/css2?family=Cinzel:wght@600;800&family=Open+Sans:wght@300;400;600&display=swap"
          as="style">
                ...
                <section class="bg-gray-100 py-12 md:py-24">
                    <div class="container mx-auto px-6 md:px-16">
                        <div class="flex flex-col gap-12">
                            ...
                            <div>
                                <p class="text-xl md:text-2xl text-gray-700 leading-relaxed">
                                    Señorito’s Garden is more than a destination — it’s a living story of serenity,
                                    beauty, and
                                    connection.
                                    Rooted in our passion for nature and inspired by community, we aim to provide an
                                    immersive
                                    garden
                                    experience where guests can slow down, reconnect with nature, and celebrate life’s
                                    most
                                    meaningful
                                    moments.
                                    <br><br>
                                    Whether you're here to wander, learn, or celebrate, our garden welcomes you with
                                    open arms and
                                    blooming hearts.
                                </p>
                                <p class="text-lg md:text-xl text-gray-600 mt-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-12 items-start">
                            ...
                            <div class="md:w-1/2">
                                ...
                                <p class="text-xl md:text-2xl text-gray-700 leading-relaxed mb-6">
                                    Step into Señorito’s Garden, a sanctuary where time slows and nature speaks. From
                                    floral trails
                                    to
                                ...
                                <ul class="space-y-4">
                                    <li class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Over 200 species of plants curated for your sensory
                                                delight and
                                    ...
                                    <li class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Celebrate weddings, birthdays, or corporate
                                                gatherings in the
                                                heart
                                    ...
                                    <li class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">Enjoy moments of mindfulness with garden yoga,
                                                meditation
                                                zones,
                    ...
                    <div class="container mx-auto px-6 md:px-16">
                        <div class="text-center mb-16">
                            ...
                            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                                Experience an enchanting blend of nature, elegance, and heartfelt moments through our
                                curated offerings.
                            </p>
                        </div>
                    ...
                    <div class="relative container mx-auto px-6 md:px-12 lg:px-20">
                        <div class="flex flex-col md:flex-row gap-12 items-start">
                            ...
                            <div class="md:w-1/2 order-last md:order-first">
                                <div
                                    class="relative rounded-xl overflow-hidden shadow-xl h-[150px] md:h-[300px] lg:h-[700px]">
                            ...
                            <div class="md:w-1/2">
                                ...
                                <ul class="space-y-6">
                                    <li class="flex items-start">
                                        <img src="{{ asset('img/bullet.png') }}"
                                             class="w-7 h-7 mt-1 mr-4 flex-shrink-0">
                                        <div>
                                            <h4 class="text-xl font-semibold text-gray-900">Breathtaking Landscapes</h4>
                                            <p class="text-base text-gray-600">
                                                Stroll through beautifully landscaped gardens filled with vibrant
                                                flowers, lush
                                    ...
                                    <li class="flex items-start">
                                        <img src="{{ asset('img/bullet.png') }}"
                                             class="w-7 h-7 mt-1 mr-4 flex-shrink-0">
                                        <div>
                                            <h4 class="text-xl font-semibold text-gray-900">Perfect Venue for
                                                Celebrations</h4>
                                            <p class="text-base text-gray-600">
                                                Whether you're planning a wedding, corporate event, or a birthday, we
                                                offer the
                                                perfect
                            ...
                            <div
                                ...
                                <p class="text-gray-600">
                                    Host intimate weddings, grand birthdays, and memorable corporate events in a garden
                                    paradise.
                                </p>
                            </div>
                            ...
                            <div
                                ...
                                <p class="text-gray-600">
                                    Enjoy peaceful spaces for yoga, quiet contemplation, or simply soaking in nature’s
                                    rhythm.
                                </p>
